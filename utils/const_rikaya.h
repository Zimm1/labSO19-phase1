...
#define DEV_LINE(DEVADDRESS) (DEVADDRESS - DEV_REGS_START) / DEV_REGBLOCK_SIZE + 3
#define DEV_NUMBER(DEVADDRESS) (DEVADDRESS - DEV_REGS_START) % DEV_REGBLOCK_SIZE / DEV_REG_SIZE
